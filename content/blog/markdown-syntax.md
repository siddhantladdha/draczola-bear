...
The following HTML `<h1>`—`<h3>` elements represent three levels of section headings.
Is there really a need for normal blogs to have more than three levels of heirarcy. Maybe..
